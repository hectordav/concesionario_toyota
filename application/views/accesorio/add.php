<div class="right_col" role="main" style="height:auto">
			...
			<div class="table-label">
				<h4><strong>Agregar Accesorio<strong></h4>
				</div>
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>accesorio/guardar_accesorio" method="POST">
				<div class="col-md-12 col-sm-12 col-xs-12">
...
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-1 col-sm-1 col-xs-1">
					  ...
					  <div class="col-md-11 col-sm-11 col-xs-12">
							<input type="text" name="txt_accesorio" id="txt_accesorio" class="form-control">
						</div>
	</div>
<!--******************los botones***********************-->
					  <div class="col-md-12 col-sm-12 col-xs-12">
