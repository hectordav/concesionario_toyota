<div class="right_col" role="main" style="height:auto;">
	    	<div class="x_panel">
                   ...
                   <div class="alert alert-warning alert-dismissible" align="left">
                    <strong>!!CUIDADO!! Ya Existe un CONTRA-PERITAJE asociado a este vehiculo &nbsp; &nbsp;<a class="btn btn-primary" href="<?=$this->config->base_url()?>contra_peritaje/ver/<?= $id_contra_peritaje?>" title="">Ir a Contra Peritaje Asociado </a> ó <a class="btn btn-primary" href="<?=$this->config->base_url()?>contra_peritaje/add_copia_contra_peritaje/<?= $id_peritaje?>/<?= $id_contra_peritaje?>" title="">Crear Copia</a> del  Contra Peritaje Asociado
										</strong>
                            <br>
                    </div>
                    <?php endif ?>
			...
			<div class="table-label">
				<h5><strong>Crear Contra-Peritaje<strong></h5>
				</div>
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>contra_peritaje/guardar_contra_peritaje" method="POST" enctype="multipart/form-data">
					<?php if ($peritaje): ?>
...
<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<?php if ($data->km_nuevo): ?>
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-10 col-sm-10 col-xs-10">
						<input type="text" class="form-control" name="txt_km" value="<?=$data->km_nuevo?>" placeholder="" readonly>
					</div>	
					<!-- * -->
</div>
				<?php else: ?>
...
<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="col-md-2 col-sm-2 col-xs-2">
			<h5 ALIGN="RIGHT"><label>&nbsp;&nbsp;Manuales:</label></h5>
		</div>
...
<?php foreach ($det_peritaje as $key): ?>
	...
	<p></p>
		...
		<?php if ($key->id_inspeccion_peritaje==42 || $key->id_inspeccion_peritaje==43 || $key->id_inspeccion_peritaje==44 || $key->id_inspeccion_peritaje==45 || $key->id_inspeccion_peritaje==46): ?>
			...
			<?php else: ?>
				<input type="radio" name="radio_<?=$key->id_inspeccion_peritaje?>" id="radio_<?=$key->id_inspeccion_peritaje?>" disabled value="1"><label><h6>Si</h6></label>
