<div class="right_col" role="main" style="height:auto;">
	    	<div class="x_panel">
                   ...
                   <div class="alert alert-warning alert-dismissible" align="left">
                    <strong>!!CUIDADO!! Ya Existe un CONTRA-PERITAJE asociado a este vehiculo &nbsp; &nbsp;<a class="btn btn-primary" href="<?=$this->config->base_url()?>contra_peritaje/ver/<?= $id_contra_peritaje?>" title="">Ir a Contra Peritaje Asociado </a>
										</strong>
                    <br>
                    </div>
                    <?php endif ?>
			...
			<div class="form-container table-container">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<p></p>
					<input type="hidden" name="txt_id_contra_peritaje" value="<?=$id_contra_peritaje?>">
