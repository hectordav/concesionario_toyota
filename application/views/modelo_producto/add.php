<div class="right_col" role="main" style="height:auto">
			...
			<div class="table-label">
				<h4><strong>Agregar Modelo de Producto<strong></h4>
				</div>
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>modelo_producto/guardar_modelo" method="POST">
				<div class="col-md-12 col-sm-12 col-xs-12">
...
<!--******************los botones***********************-->
					...
					<div class="col-md-2 col-sm-2 col-xs-2">
					    ...
					    <div class="col-md-offset-2 col-md-11">
					      ...
					      <a href="<?php echo $this->config->base_url();?>modelo_producto"><button type="button" class="btn  btn-lg btn-danger"><i class="fa  fa-exclamation-triangle"></i>&nbsp;Cancelar</button></a>
						</form>
					    </div>
					 </div>
			</div>
