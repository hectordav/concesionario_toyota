<div class="right_col" role="main" style="height:auto;">
		 ...
		 <?$correcto = $this->session->flashdata('alerta1');?> 
		 <?php if ($correcto): ?>
	             <div class="animated bounceInDown">
                   <div class="alert alert-info alert-dismissible">
                    <strong>!!CUIDADO!! Ya Existe un peritaje asociado a este vehiculo &nbsp; &nbsp; <a class="btn btn-primary" href="<?=$this->config->base_url()?>peritaje/ver/<?= $id_peritaje?>" title="">Ir a Peritaje Asociado </a></strong>
			...
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>peritaje/guardar_peritaje" method="POST" enctype="multipart/form-data">
...
<div class="form-group">
					<div class="col-md-1 col-sm-1 col-xs-1">
						<h4><P ALIGN="RIGHT"><label>Patente:</label></h4></P>
					</div>
					<div class="col-md-11 col-sm-11 col-xs-12">
