...
<div <div class="form-group">
		...
		<div class="col-md-1 col-sm-1 col-xs-2">
			<h5><P ALIGN="RIGHT"><label>Asignado</label></h5></P>
		</div>
		<div class="col-md-11 col-sm-11 col-xs-12">
...
<div class="col-md-2 col-sm-2 col-xs-2 col-lg-offset-1 col-xs-offset-1 col-sm-offset-1">
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
	...
	<strong>
	&nbsp;
	<input type="radio"onclick="continuar();"  name="estado_inspeccion_<?=$key->id?>" id="estado_inspeccion_<?=$key->id?>" value="1" checked="checked"><label>B</label>
	<input type="radio" onclick=" continuar();continuar_2();" name="estado_inspeccion_<?=$key->id?>" id="estado_inspeccion_<?=$key->id?>" value="2"><label>R</label>
	<input type="radio" name="estado_inspeccion_<?=$key->id?>" id="estado_inspeccion_<?=$key->id?>" value="3" onclick="continuar();"><label>M</label>
	</strong>
	</div>
</div>
<?php endforeach ?>
...
<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-12 col-sm-12 col-xs-12">
				<h4><label>Nota: Se Creará una copia del peritaje original (puede buscarla al final de ver peritaje)</label></h4></P>
			</div>
	</div>
