<div class="right_col" role="main" style="height:auto;">
			...
			<div class="table-label">
				<h5><strong>Ver Peritaje<strong></h5>
				</div>
...
<?php if ($data->km_nuevo): ?>
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-1 col-sm-1 col-xs-2">
						<h5><P ALIGN="RIGHT"><label>Km Nuevo:</label></h5></P>
					</div>
					<div class="col-md-11 col-sm-11 col-xs-12">
						<input type="text" class="form-control" name="txt_km_nuevo" value="<?=$data->km_nuevo?>" placeholder="" readonly>
					</div>
</div>
	<?php else: ?>
<?php endif ?>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
	...
	<?php if ($peritaje): ?>
		<?php foreach ($peritaje as $key): ?>
			<?php if ($key->ins_motor==1): ?>
				<input type="radio"onclick="continuar();"  name="estado_inspeccion_1" id="estado_inspeccion_1" value="1" checked="checked"><label>B</label>
				<input type="radio" onclick="continuar();" name="estado_inspeccion_1" id="estado_inspeccion_1" value="2" disabled="true"><label>R</label>
				<input type="radio" name="estado_inspeccion_1" id="estado_inspeccion_1" value="3" onclick="continuar();" disabled="true"><label>M</label>
				<?php else: ?>
					<?php if ($key->ins_motor==2): ?>
				<input type="radio"onclick="continuar();"  name="estado_inspeccion_1" id="estado_inspeccion_1" value="1" disabled="true"><label>B</label>
				<input type="radio" onclick="continuar();" name="estado_inspeccion_1" id="estado_inspeccion_1" value="2"checked="checked"><label>R</label>
				<input type="radio" name="estado_inspeccion_1" id="estado_inspeccion_1" value="3" onclick="continuar();"disabled="true"><label>M</label>
						<?php else: ?>
							<?php if ($key->ins_motor==3): ?>

				<input type="radio"onclick="continuar();"  name="estado_inspeccion_1" id="estado_inspeccion_1" value="1" disabled="true"><label>B</label>
				<input type="radio" onclick="continuar();" name="estado_inspeccion_1" id="estado_inspeccion_1" value="2"disabled="true"><label>R</label>
				<input type="radio" name="estado_inspeccion_1" id="estado_inspeccion_1" value="3" onclick="continuar();" checked="checked"><label>M</label>
							<?php endif ?>
					<?php endif ?>
			<?php endif ?>
		<?php endforeach ?>
...
<hr>
		...
		<?php if ($ver_peritaje_id_peritaje_original): ?>
			<?php foreach ($ver_peritaje_id_peritaje_original as $key): ?>
				Copias Realizadas: &nbsp;
				<?$fecha_peritaje= date("d-m-Y",strtotime($key->fecha_peritaje)); ;?>	
				<a href="<?=$this->config->base_url()?>peritaje/ver/<?=$key->id_peritaje?>"><?=$fecha_peritaje?></a>&nbsp;&nbsp;
			<?php endforeach ?>
		<?php else: ?>
		<?php endif ?>
	<div class="col-md-12 col-sm-12 col-xs-12">
			<?php if ($peritaje): ?>
		<?php foreach ($peritaje as $key): ?>
			<?php if ($key->id_peritaje_original>0): ?>
				<?$fecha=date('d-m-Y',strtotime($key->fecha_peritaje))?>
				<br>
				<label> Fecha del Primer peritaje: <?=$fecha?> <a href="<?=$this->config->base_url()?>peritaje/ver/<?=$key->id_peritaje_original?>" class="btn btn-info"> Ir a Peritaje</a></label>
			<?php endif ?>
		<?php endforeach ?>
	<?php endif ?>
