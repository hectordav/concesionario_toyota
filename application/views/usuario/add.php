<div class="right_col" role="main" style="height:650px;">
			...
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>usuario/guardar_usuario" method="POST">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-10 col-sm-10 col-xs-10">
						<input type="text" class="form-control" name="txt_nombre" value="<?= set_value("txt_nombre")?>" placeholder="Ingrese Nombre de Usuario" required="required">
					</div>
						<hr>
					</div>
<!--*****************************************************************************-->
<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-10 col-sm-10 col-xs-10">
						<input type="email" class="form-control" name="txt_login" value="<?= set_value("txt_login")?>" placeholder="Ingrese Email" required="required">	
