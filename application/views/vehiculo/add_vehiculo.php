<div class="right_col" role="main" style="height:auto">
			...
			<div class="table-label">
				<h4><strong>Agregar Vehiculo<strong></h4>
				</div>
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>vehiculo/guardar_vehiculo" method="POST">
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
	<p></p>
...
<!--**************************************************************** -->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-1 col-sm-1 col-xs-12">
					  ...
					  <div class="col-md-11 col-sm-11 col-xs-12">
							<input type="number"required name="txt_ano" id="txt_ano" class="form-control" placeholder="Ingrese Año">
						</div>
	</div>
<!--**************************************************************** -->
	<div class="col-md-12 col-sm-12 col-xs-12">
...
<!--*********************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-1 col-sm-1 col-xs-12">
					  ...
					  <div class="col-md-11 col-sm-11 col-xs-12">
							<input type="text"required name="txt_patente" id="txt_patente" class="form-control" placeholder="Ingrese Patente">
						</div>
	</div>
<!--*********************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-1 col-sm-1 col-xs-12">
					  ...
					  <div class="col-md-11 col-sm-11 col-xs-12">
							<input type="text"required name="txt_serial_carroceria" id="txt_serial_carroceria" class="form-control" placeholder="Ingrese los 8 ultimos Digitos">
						</div>
...
<!--*********************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-1 col-sm-1 col-xs-12">
					  ...
					  <div class="col-md-11 col-sm-11 col-xs-12">
							<input type="text"required name="txt_sn_motor" id="txt_sn_motor" class="form-control" placeholder="Ingrese los 8 ultimos Digitos">
						</div>
	</div>
<!-- **************************************************************** -->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-1 col-sm-1 col-xs-12">
					  ...
					  <div class="col-md-11 col-sm-11 col-xs-12">
							<input type="number"required name="txt_kilometraje" id="txt_kilometraje" class="form-control" placeholder="Ingrese Kilometraje">
						</div>
	</div>
