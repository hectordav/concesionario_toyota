    ...
    <div class="container gc-container">
        ...
        ?></div>
 		...
 		<div class="row">
                ...
                <div class="table-label bordered table-responsive" >
                    <div class="floatL l5">
                       <h4> <strong><?php echo $subject_plural; ?></strong></h4>
                    </div>
                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                            <div id="div1" class="animated slideInUp">
                                <div class="floatL t5">
        			    ...
        			    <table class="table table-bordered grocery-crud-table table-hover">
        					<thead>
                              ...
                              <?php foreach($columns as $column){?>
                                  <th class="column-with-ordering info" data-order-by="<?php echo $column->field_name; ?>"><?php echo $column->display_as; ?></th>
                              <?php }?>
        						</tr>
                                    ...
                                    <td colspan="<?php echo $colspans; ?>">
                                            ...
                                            <div class="floatR r5">
                                                <ul class="pagination">
                                                    ...
                                                    <li>
            <span class="page-number-input-container" style="width:80px; height:32.3px;">
